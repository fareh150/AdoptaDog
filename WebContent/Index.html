...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <!--  <p><a href="#">Perros por tamaño</a></p>
    ...
    <div class="col-sm-8 text-left"> 
     ...
     <div class="w3-content w3-section" style="max-width:500px">
      ...
      <div class="w3-display-container mySlides">
         <!-- <a href="#">-->
         <img src="image/perro1.jpg" style="width:100%"><!--</a>-->
          <div class="w3-display-topright w3-large w3-container w3-padding-15 w3-black">
            Perriquitin
          </div>
        </div>
...
function carousel() {
    ...
    setTimeout(carousel, 2000); // Change image every 2 seconds
      ...
      <p>Casi 138.000 perros abandonados fueron recogidos de las calles de España durante 2016 por protectoras de animales. Solo el 16% volvió con sus dueños y 45% fue adoptado en un nuevo hogar, de acuerdo con el Estudio de Abandono y Adopción 2017 elaborado por la Fundación Affinity. La organización alerta de que la principal razón de abandono es el nacimiento de camadas indeseadas.</p>
      <hr>
